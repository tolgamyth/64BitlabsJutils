...
import com._64bitlabs.util.exception.BadLineEndingException;
...
public class CSVPrinter implements CSVPrint {
	 ...
	 * @throws com._64bitlabs.util.exception.BadLineEndingException if the line ending is not one of the three legal line endings.
	 *
	 * @since 64bitlabsutils 1.06.01
	 */
