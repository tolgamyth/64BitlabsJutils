 ...
 * </pre>
 * <P>
 * The CSV that Excel outputs differs the format read by CSVParser:
...
public class ExcelCSVParser implements CSVParse {
	 ...
	 *
	 * @throws com._64bitlabs.util.exception.BadDelimiterException if the specified delimiter cannot be used
	 *
	 * @since 64bitlabsutils 1.02.24
	 */
