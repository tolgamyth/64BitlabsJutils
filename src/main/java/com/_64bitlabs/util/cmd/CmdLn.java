...
public final class CmdLn {
	 ...
	 * @throws com._64bitlabs.util.exception.UnknownCmdLnOptionException if an unexpected option is encountered during parsing.
	 * @throws com._64bitlabs.util.exception.MissingCmdLnArgumentException if a command line option does not have enough arguments during parsing.
	 * @throws com._64bitlabs.util.exception.ExtraCmdLnArgumentException if a command line option has too many arguments during parsing.
	 *
	 * @since 64bitlabsutils 1.07.00
	 */
	 ...
	 *
	 * @param sArgument command line argument to check to see if it is a short argument
	 ...
	 *
	 * @throws com._64bitlabs.util.exception.UnknownCmdLnOptionException if an unexpected option is encountered.
	 * @throws com._64bitlabs.util.exception.ExtraCmdLnArgumentException if a command line option has too many arguments.
	 *
	 * @since 64bitlabsutils 1.07.00
	 */
	 ...
	 * @throws com._64bitlabs.util.exception.MissingCmdLnArgumentException if a command line option does not have enough arguments.
