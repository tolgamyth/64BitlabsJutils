...
import com._64bitlabs.util.exception.BinaryDataException;
		...
		for(CmdLnResult result: commandLine.getResults()){
			switch((TabsCmdLnOption)result.getOption().getUserObject()){
				...
				case ABOUT:{
					System.out.println(
						labels.getString("tabs") + " -- " + labels.getString("purpose.message") + "\n" +
						MessageFormat.format(labels.getString("copyright"), (Object[])new String[] {"2002-2007", "Tolga Yilmaz (info@64bitlabs.com)"}) + "\n\n" +
